...
async function supportArticleData(
  ...
  return await payload.create({
    ...
    data: {
      ...
      meta: {
        title: "Support Article - Corporate",
        description: "Support Article - Corporate",
...
export default supportArticleData
